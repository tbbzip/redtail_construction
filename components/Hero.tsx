  ...
  <div className="container relative z-10 px-6 py-16 mt-48 mx-auto text-center">
    <div className="max-w-lg mx-auto">
      <h1 className="text-4xl font-semibold text-white lg:text-5xl drop-shadow-md">
        Revolutionize Your Car Rental Business with Telematics Solutions
      </h1>
      <p className="mt-10 text-white drop-shadow-md">
      Maximize Fleet Efficiency, Reduce Costs, and Enhance Customer Experience with Redtail Telematics Solutions
      </p>
      <button
        className="px-5 py-2 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-rb-100 rounded-lg hover:bg-red-500 focus:outline-none drop-shadow-md"
